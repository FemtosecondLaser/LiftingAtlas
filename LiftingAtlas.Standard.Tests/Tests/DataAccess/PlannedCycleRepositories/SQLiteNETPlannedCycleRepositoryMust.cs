...
{
    [TestFixture]
    public class SQLiteNETPlannedCycleRepositoryMust
    {
        public IGuidProvider guidProvider;
        public SQLiteNETPlannedCycleRepository sQLitePlannedCycleRepository;
        ...
        public void SetUp()
        {
            sQLitePlannedCycleRepository =
                new SQLiteNETPlannedCycleRepository(
                    guidProvider,
                    ":memory:"
                    );
        }
